...
\begin{frame}
  ...
  \begin{enumerate}
    \item \textbf{Monotonous:} there is a general direction in the association between two variables (rising/falling)
    \item \textbf{Non-monotonous:} there is a systematic association, but it is not consistently rising/falling
  \end{enumerate}
\end{frame}

\begin{frame}
  \frametitle{Linear regression}
  The association between the dependent and independent variable is approximated with a line.
  
  \begin{itemize}
    \item Is the association linear at all?
    \item Direction: rising/falling?
    \item How strong is the association? Strong or even non-existent?
  \end{itemize}
\end{frame}
...
\begin{frame}
  \frametitle{Pearson's correlation coefficient and coefficient of determination}
...
\begin{frame}
  ...
  \begin{tikzpicture}
    ...
    \end{axis}
  \end{tikzpicture}
  We find that $\overline{x} = 2$ and $\overline{y} = 4.3$.
\end{frame}
...
\begin{frame}
  ...
  \begin{tikzpicture}
    ...
    \end{axis}
  \end{tikzpicture}
  We find that $\overline{x} = 1942.625$ and $\overline{y} = 3.4375$.
\end{frame}
...
\begin{frame}
  \frametitle{Strength association reindeers}
  \begin{columns}
    \begin{column}{0.5\textwidth}
      \begin{table}[h] \centering
