...
\include{1_getting-started}
\include{2_research-process}
\include{3_univariate-analysis}
\include{4_central_limit_theorem}
\include{5_testing_procedures} 
\include{6_bivariate_analysis}
\include{7_time_series}
\include{A_notation}
