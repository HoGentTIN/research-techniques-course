...
A clinical study investigates whether a new drug has a reduced reaction speed as a side effect (Lindquist, g.d.). 
...
In this variant of the $t$-test, each element of the sample is measured two times, one time before and one time after a certain intervention. The goal is to find out if the intervention had a significant effect on the measurement.
...
We use a paired $t$-test to determine whether cars are significantly more efficient when using petrol with additives.
